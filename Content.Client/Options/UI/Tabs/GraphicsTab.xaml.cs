...
public sealed partial class GraphicsTab : Control
{
    ...
    public GraphicsTab()
    {
        ...
        // === RTX Edition ===
        Control.AddOptionCheckBox(FreakyStationCCVars.BloomEnabled, BloomEnabledCheckBox);
        Control.AddOption(new OptionSliderFloatCVar(Control, _cfg, FreakyStationCCVars.BloomIntensity, BloomIntensitySlider, 0f, 1f, 3f, FormatFloat));
        Control.AddOption(new OptionSliderFloatCVar(Control, _cfg, FreakyStationCCVars.BloomThreshold, BloomThresholdSlider, 0f, 1f, 1f, FormatFloat));
        Control.AddOptionCheckBox(FreakyStationCCVars.ToneMappingEnabled, ToneMappingEnabledCheckBox);
        Control.AddOption(new OptionSliderFloatCVar(Control, _cfg, FreakyStationCCVars.ToneMappingExposure, ToneMappingExposureSlider, 0f, 1f, 4f, FormatFloat));
        Control.AddOptionCheckBox(FreakyStationCCVars.VignetteEnabled, VignetteEnabledCheckBox);
        Control.AddOptionCheckBox(FreakyStationCCVars.FakeNormalEnabled, FakeNormalEnabledCheckBox);
        Control.AddOption(new OptionSliderFloatCVar(Control, _cfg, FreakyStationCCVars.FakeNormalStrength, FakeNormalStrengthSlider, 0f, 1f, 3f, FormatFloat));
        Control.AddOption(new OptionSliderFloatCVar(Control, _cfg, FreakyStationCCVars.FakeLightWrap, FakeLightWrapSlider, 0f, 1f, 1f, FormatFloat));
        Control.AddOption(new OptionSliderFloatCVar(Control, _cfg, FreakyStationCCVars.FakeLightIntensity, FakeLightIntensitySlider, 0f, 1f, 2f, FormatFloat));
    ...
    private static string FormatFloat(OptionSliderFloatCVar slider, float value)
    {
        return $"{value:F2}";
    }
        ...
        public override void SaveValue()
        {
            switch (_dropDown.Button.SelectedId)
            {
                case QualityVeryLow:
                    ...
                    _cfg.SetCVar(CCVars.EnableLightsGlowing, false);
                    break;
                case QualityLow:
                ...
                default:
                    ...
                    _cfg.SetCVar(CVars.LightBlur, true);
                    _cfg.SetCVar(CCVars.EnableLightsGlowing, true);
                    break;
                case QualityHigh:
