...
ui-options-rtx-label = RTX Edition
ui-options-bloom-enabled = Блум
ui-options-bloom-intensity = Интенсивность блума
ui-options-bloom-threshold = Порог блума
ui-options-tonemapping-enabled = Тональное отображение (ACES)
ui-options-tonemapping-exposure = Экспозиция
ui-options-vignette-enabled = Виньетка
ui-options-fakenormal-enabled = Фейковое освещение нормалей
ui-options-fakenormal-strength = Сила нормалей
ui-options-fakelight-wrap = Мягкость света
ui-options-fakelight-intensity = Интенсивность света
