...
ui-options-bloom-enabled = Bloom
ui-options-bloom-intensity = Bloom Intensity
ui-options-bloom-threshold = Bloom Threshold
ui-options-tonemapping-enabled = Tone Mapping (ACES)
ui-options-tonemapping-exposure = Tone Mapping Exposure
ui-options-vignette-enabled = Vignette
ui-options-fakenormal-enabled = Fake Normal Lighting
ui-options-fakenormal-strength = Normal Strength
ui-options-fakelight-wrap = Light Wrap
ui-options-fakelight-intensity = Light Intensity
